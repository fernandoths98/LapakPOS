...
export function BillSuccessScreen() {
  ...
  return <SafeAreaView style={styles.container} edges={[]}>
    ...
    <View style={[styles.successIcon, pending && styles.pendingIcon]}>{pending ? <Clock size={34} color={colors.surface} strokeWidth={2.4} /> : <Check size={38} color={colors.surface} strokeWidth={3} />}</View>
