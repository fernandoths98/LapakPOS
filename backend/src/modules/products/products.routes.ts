...
productsRouter.get("/", requireAuth, resolveOutlet, asyncHandler(listProductsHandler));
...
productsRouter.get("/barcode/:code", requireAuth, resolveOutlet, asyncHandler(getProductByBarcodeHandler));
productsRouter.get("/:id", requireAuth, resolveOutlet, asyncHandler(getProductHandler));
productsRouter.patch("/:id", requireAuth, resolveOutlet, asyncHandler(updateProductHandler));
